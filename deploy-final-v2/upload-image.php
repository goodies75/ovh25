...
try {
    ...
    foreach ($imageFormats as $format => $specs) {
        ...
        try {
            ...
            // Générer les URLs (complète et relative)
            $formatUrl = 'uploads/' . $formatFilename; // URL relative par défaut
            ...
            if (strpos($_SERVER['HTTP_HOST'], 'localhost') !== false || 
                ...
                $formatUrl = $protocol . $host . $scriptPath . '/uploads/' . $formatFilename;
            }
